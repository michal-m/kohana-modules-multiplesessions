...
abstract class Sessions
{
    ...
    /**
     * Gives a possibility to destroy the session cookie. This will prove useful
     * when cookie data is malformed and throws an exception when reading.
     *
     *      Session::destroy_cookie('session');
     *
